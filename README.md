...
После входа в систему, пользователь сможет изменить взятую из базы данных дополнительную информацию (данная информация будет использоваться для расчёта суточной нормы воды). 
#### PersonalDataChange()
